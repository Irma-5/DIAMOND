...
pygame.draw.rect(red_image, RED, red_image.get_rect(), 0)
pygame.draw.rect(green_image, GREEN, green_image.get_rect(), 0)
pygame.draw.rect(blue_image, BLUE, blue_image.get_rect(), 0)
pygame.draw.rect(purple_image, PURPLE, purple_image.get_rect(), 0)
